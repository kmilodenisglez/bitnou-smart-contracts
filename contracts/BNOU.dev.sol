...
contract BNOUDev is ERC20, Ownable {
    ...
    {   
        ...
        if (block.chainid == 56) {
            ...
            // Hardhat local development network - use BSC Testnet router for reference
        ...
        if (!isLocalNetwork) {
            ...
            // Use placeholder on local networks
        ...
        _mint(owner(), 500_000_000 * (10 ** decimals()));
